...
class LibrosControllerTest < ActionController::TestCase
  ...
  test "should create libro" do
    assert_difference('Libro.count') do
      post :create, libro: { autor_id: @libro.autor_id, genero_id: @libro.genero_id, idioma: @libro.idioma, nombre: @libro.nombre }
    end
  ...
  test "should update libro" do
    patch :update, id: @libro, libro: { autor_id: @libro.autor_id, genero_id: @libro.genero_id, idioma: @libro.idioma, nombre: @libro.nombre }
    assert_redirected_to libro_path(assigns(:libro))
  end
