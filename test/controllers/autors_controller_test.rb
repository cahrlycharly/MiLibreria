...
class AutorsControllerTest < ActionController::TestCase
  ...
  test "should create autor" do
    assert_difference('Autor.count') do
      post :create, autor: { apellido: @autor.apellido, genero_id: @autor.genero_id, nacionalidad: @autor.nacionalidad, nombre: @autor.nombre }
    end
  ...
  test "should update autor" do
    patch :update, id: @autor, autor: { apellido: @autor.apellido, genero_id: @autor.genero_id, nacionalidad: @autor.nacionalidad, nombre: @autor.nombre }
    assert_redirected_to autor_path(assigns(:autor))
  end
