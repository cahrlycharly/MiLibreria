...
class LectorsControllerTest < ActionController::TestCase
  ...
  test "should create lector" do
    assert_difference('Lector.count') do
      post :create, lector: { apellido: @lector.apellido, libro_id: @lector.libro_id, nombre: @lector.nombre, oficina: @lector.oficina }
    end
  ...
  test "should update lector" do
    patch :update, id: @lector, lector: { apellido: @lector.apellido, libro_id: @lector.libro_id, nombre: @lector.nombre, oficina: @lector.oficina }
    assert_redirected_to lector_path(assigns(:lector))
  end
